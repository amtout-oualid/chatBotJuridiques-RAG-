...
print(" EMBEDDINGS PATCH-LEVEL")

BASE_DIR = Path(__file__).resolve().parent.parent
PAGES_DIR = BASE_DIR / "data" / "pages"
OUT_DIR = BASE_DIR / "artifacts" / "embeddings_patch"
...
for doc_dir in PAGES_DIR.iterdir():
    ...
    for img_path in sorted(doc_dir.glob("*.png")):
        ...
        print(f"     {len(patches)} patches traités et sauvegardés")

print("Embeddings patch-level terminés")
